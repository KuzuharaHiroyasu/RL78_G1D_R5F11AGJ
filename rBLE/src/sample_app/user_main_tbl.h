...
/************************************************************/
/* バージョン表記の注意事項 */
const B		version_product_tbl[]= {1, 0, 1, 30};				/* ソフトウェアバージョン */
																/* バージョン表記ルール */
																/* ①メジャーバージョン：[0 ～ 99] */
																/* ②マイナーバージョン：[0 ～ 9] */
																/* ③リビジョン：[0 ～ 99] */
...
/*電源SW(短)		*/	{ evt_non,			evt_demo_vib,		evt_non,		evt_non,			evt_non,		evt_non,		evt_non,			evt_non },
/*電源SW押下(長)	*/	{ evt_idle_com,		evt_non,			evt_idle_com,	evt_sensing_chg,	evt_non,		evt_non,		evt_non,			evt_non },
