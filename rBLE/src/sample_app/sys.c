...
//#define CHAR_BIT		8		//limits.hで定義済み
...
/* 引数     : なし														*/
/* 戻り値   : なし														*/
/* 変更履歴 : 2018.05.17 Axia Soft Design 西島 稔	初版作成			*/
/************************************************************************/
/* 機能 :ms待ち関数														*/
/************************************************************************/
/* 注意事項 : 時間は正確では無い										*/
/* ①1ms≒1.05ms,5ms≒5.35msである事を確認(2018.09.11)					*/
/************************************************************************/
void wait_ms( int ms )
{
	int i,j;
