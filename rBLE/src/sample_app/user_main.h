...
#define		SUPPRESS_INTERVAL_CNT_5_MIN			30		// 10秒毎 1分(6) * 5  = 30回 = 5分
#define		SUPPRESS_INTERVAL_CNT_10_MIN		60		// 10秒毎 1分(6) * 10 = 60回 = 10分
...
#define	BREATH_VALLEY					50			// 呼吸の谷間と判断するAD値
#define	VIB_START_LIMIT					60			// バイブの開始待ちリミット（設定時間、呼吸の谷間が判定されなかった場合バイブ開始）
													// 1000ms(1秒) / 50 = 20	2秒 = 40	2.5秒 = 50	〇3秒 = 60
...
#define VUART_CMD_DIAG_POWER_OFF	0xAA
...
#define VUART_DATA_DIAG_SEND_CNT	200
...
extern UB set_suppress_max_time(void);
