...
STATIC void main_mode_chg( void );				// ¡b’è
...
//	char dbg_tx_data[50] = {0};
	...
	cpu_com_proc();			// CPUŠÔ’ÊMƒT[ƒrƒX
	
	main_vuart_proc();		// VUART’ÊMƒT[ƒrƒX
	
	main_cpu_com_proc();	// ’ÊMƒT[ƒrƒXƒAƒvƒŠ
...
void user_main_timer_cyc( void )
{
	...
	//		ke_evt_set(KE_EVT_USR_1_BIT);
			...
			// 12ŠÔ‚ğ’´‚¦‚½ or [“dc—Ê‚È‚µ or [“d’†‚È‚ç‘Ò‹@ƒ‚[ƒh‚Ö
...
STATIC void user_main_mode_sensing_before( void )
{
	...
	{//“d’rc—Ê‚È‚µA[“d’†‚È‚çƒZƒ“ƒVƒ“ƒOƒ‚[ƒhˆÚsˆ—‚ğ‚µ‚È‚¢
		// “úî•ñæ“¾
...
/************************************************************************/
/* ŠÖ”     : user_main_mode_prg_hd_before								*/
/* ŠÖ”–¼   : ƒvƒƒOƒ‰ƒ€XV(H1D)‘Oˆ—									*/
/* ˆø”     : ‚È‚µ														*/
/* –ß‚è’l   : ‚È‚µ														*/
/* •ÏX—š—ğ	: 2018.09.10 Axia Soft Design ¼“‡ –«	‰”Åì¬			*/
/************************************************************************/
/* ‹@”\ : ƒvƒƒOƒ‰ƒ€XV(H1D)‘Oˆ—										*/
/************************************************************************/
/* ’ˆÓ–€ :‚È‚µ														*/
/************************************************************************/
...
/************************************************************************/
/* ŠÖ”     : user_main_mode_idle_rest									*/
/* ŠÖ”–¼   : ƒAƒCƒhƒ‹_c—Ê•\¦ó‘Ôˆ—									*/
/* ˆø”     : ‚È‚µ														*/
/* –ß‚è’l   : ‚È‚µ														*/
/* •ÏX—š—ğ	: 2018.09.10 Axia Soft Design ¼“‡ –«	‰”Åì¬			*/
/************************************************************************/
...
/************************************************************************/
/* ŠÖ”     : user_main_mode_prg_h1d									*/
/* ŠÖ”–¼   : H1DƒvƒƒOƒ‰ƒ€XVó‘Ôˆ—									*/
/* ˆø”     : ‚È‚µ														*/
/* –ß‚è’l   : ‚È‚µ														*/
/* •ÏX—š—ğ	: 2018.09.10 Axia Soft Design ¼“‡ –«	‰”Åì¬			*/
/************************************************************************/
/* ‹@”\ : H1DƒvƒƒOƒ‰ƒ€XVó‘Ôˆ—										*/
/************************************************************************/
/* ’ˆÓ–€ :‚È‚µ														*/
/************************************************************************/
STATIC void user_main_mode_prg_h1d(void)
...
/************************************************************************/
/* ŠÖ”     : evt_idle_rest												*/
/* ŠÖ”–¼   : ƒCƒxƒ“ƒg(ƒAƒCƒhƒ‹_c—Ê•\¦)								*/
/* ˆø”     : evt	ƒCƒxƒ“ƒg”Ô†										*/
/* –ß‚è’l   : ƒVƒXƒeƒ€ƒ‚[ƒh											*/
/* •ÏX—š—ğ : 2018.09.07  Axia Soft Design ¼“‡ ‰”Åì¬				*/
/************************************************************************/
/* ‹@”\ : ƒCƒxƒ“ƒg(ƒAƒCƒhƒ‹_c—Ê•\¦)									*/
/************************************************************************/
/* ’ˆÓ–€ :‚È‚µ														*/
/************************************************************************/
STATIC SYSTEM_MODE evt_idle_rest( int evt)
...
/************************************************************************/
/* ŠÖ”     : evt_initial_chg											*/
/* ŠÖ”–¼   : ƒCƒxƒ“ƒg(ƒCƒjƒVƒƒƒ‹_[“dƒ`ƒFƒbƒN‚ ‚è)						*/
/* ˆø”     : evt	ƒCƒxƒ“ƒg”Ô†										*/
/* –ß‚è’l   : ƒVƒXƒeƒ€ƒ‚[ƒh											*/
/* •ÏX—š—ğ : 2018.09.07  Axia Soft Design ¼“‡ ‰”Åì¬				*/
/************************************************************************/
/* ‹@”\ : ƒCƒxƒ“ƒg(ƒCƒjƒVƒƒƒ‹_[“dƒ`ƒFƒbƒN‚ ‚è)							*/
/************************************************************************/
/* ’ˆÓ–€ :‚È‚µ														*/
/************************************************************************/
STATIC SYSTEM_MODE evt_initial_chg( int evt)
...
/************************************************************************/
/* ŠÖ”     : evt_h1d_prg_denchi										*/
/* ŠÖ”–¼   : ƒCƒxƒ“ƒg(H1DƒvƒƒOƒ‰ƒ€XV_“d’rƒ`ƒFƒbƒN‚ ‚è)				*/
/* ˆø”     : evt	ƒCƒxƒ“ƒg”Ô†										*/
/* –ß‚è’l   : ƒVƒXƒeƒ€ƒ‚[ƒh											*/
/* •ÏX—š—ğ : 2018.09.07  Axia Soft Design ¼“‡ ‰”Åì¬				*/
/************************************************************************/
/* ‹@”\ : ƒCƒxƒ“ƒg(H1DƒvƒƒOƒ‰ƒ€XV_“d’rƒ`ƒFƒbƒN‚ ‚è)					*/
/************************************************************************/
/* ’ˆÓ–€ :‚È‚µ														*/
/************************************************************************/
STATIC SYSTEM_MODE evt_h1d_prg_denchi( int evt)
...
/************************************************************************/
/* ŠÖ”     : evt_prg_h1d_fin											*/
/* ŠÖ”–¼   : ƒCƒxƒ“ƒg(H1DƒvƒƒOƒ‰ƒ€‘‚«Š·‚¦Š®—¹)						*/
/* ˆø”     : evt	ƒCƒxƒ“ƒg”Ô†										*/
/* –ß‚è’l   : ƒVƒXƒeƒ€ƒ‚[ƒh											*/
/* •ÏX—š—ğ : 2018.09.13  Axia Soft Design ¼“‡ ‰”Åì¬				*/
/************************************************************************/
/* ‹@”\ : ƒCƒxƒ“ƒg(H1DƒvƒƒOƒ‰ƒ€‘‚«Š·‚¦Š®—¹)							*/
/************************************************************************/
/* ’ˆÓ–€ :‚È‚µ														*/
/************************************************************************/
STATIC SYSTEM_MODE evt_prg_h1d_fin( int evt)
{
	...
	// EEP‚ğÁ‹‚µ’Êíƒ‚[ƒh‚Åg‚¦‚é‚æ‚¤‚É‚µ‚Ä‚¨‚­ ¦ƒŠƒZƒbƒg‚ğŒo—R‚µ‚È‚¢ƒP[ƒX‚ª‚ ‚éˆ×
	eep_part_erase();
	
	// ˆÚs‚Ìˆ—‚Í“¯‚¶‚È‚Ì‚Å‰º‹LŠÖ”‚ÅÀs
...
/************************************************************************/
/* ŠÖ”     : evt_prg_h1d_time_out										*/
/* ŠÖ”–¼   : ƒCƒxƒ“ƒg(H1DƒvƒƒOƒ‰ƒ€‘‚«Š·‚¦ƒ^ƒCƒ€ƒAƒEƒg)				*/
/* ˆø”     : evt	ƒCƒxƒ“ƒg”Ô†										*/
/* –ß‚è’l   : ƒVƒXƒeƒ€ƒ‚[ƒh											*/
/* •ÏX—š—ğ : 2018.09.13  Axia Soft Design ¼“‡ ‰”Åì¬				*/
/************************************************************************/
/* ‹@”\ : ƒCƒxƒ“ƒg(H1DƒvƒƒOƒ‰ƒ€‘‚«Š·‚¦ƒ^ƒCƒ€ƒAƒEƒg)					*/
/************************************************************************/
/* ’ˆÓ–€ :‚È‚µ														*/
/************************************************************************/
STATIC SYSTEM_MODE evt_prg_h1d_time_out( int evt)
...
// =============================================================
/************************************************************************/
/* ŠÖ”     : user_main_req_cyc											*/
/* ŠÖ”–¼   : ƒXƒe[ƒ^ƒX—v‹üŠúˆ—									*/
/* ˆø”     : ‚È‚µ														*/
/* –ß‚è’l   : ‚È‚µ														*/
/* •ÏX—š—ğ : 2018.09.07  Axia Soft Design ¼“‡ ‰”Åì¬				*/
/************************************************************************/
...
STATIC void user_main_req_cyc( void )
{
	...
	if(( now_time - s_unit.last_time_sts_req ) >= MAIN_STATUS_REQ_TIME ){
		if( ON == main_cpu_com_snd_sts_req() ){		/* ƒXƒe[ƒ^ƒX—v‹‘—M */
...
/************************************************************************/
/* ŠÖ”     : main_cpu_com_snd_sensing_order							*/
/* ŠÖ”–¼   : ƒZƒ“ƒVƒ“ƒOw¦‘—M										*/
/* ˆø”     : ‚È‚µ														*/
/* –ß‚è’l   : ‚È‚µ														*/
/* •ÏX—š—ğ : 2018.08.01  Axia Soft Design ¼“‡ ‰”Åì¬				*/
/************************************************************************/
/* ‹@”\ : ƒZƒ“ƒVƒ“ƒOw¦‘—M											*/
/************************************************************************/
/* ’ˆÓ–€ :‚È‚µ														*/
...
STATIC void main_cpu_com_rcv_date_set( void )
{
	...
	tx[1] = s_ds.cpu_com.input.rcv_data[0];		// CPUŠÔ‚Ì‰“š‚ğ‚»‚Ì‚Ü‚Ü“ü‚ê‚é
	main_vuart_send( &tx[0], 2 );
...
/************************************************************************/
/* ŠÖ”     : main_cpu_com_rcv_sts_res									*/
/* ŠÖ”–¼   : CPUŠÔ’ÊMóM(ƒXƒe[ƒ^ƒX—v‹)								*/
/* ˆø”     : ‚È‚µ														*/
/* –ß‚è’l   : ‚È‚µ														*/
/* •ÏX—š—ğ : 2018.05.19  Axia Soft Design ¼“‡ ‰”Åì¬				*/
/************************************************************************/
/* ‹@”\ : CPUŠÔ’ÊMóM(ƒXƒe[ƒ^ƒX—v‹)									*/
/************************************************************************/
/* ’ˆÓ–€ :‚È‚µ														*/
/************************************************************************/
STATIC void main_cpu_com_rcv_sts_res( void )
{
	...
	if(( BAT_LEVEL_STS_MIN == s_unit.battery_sts ) &&
	   (( now_time - s_unit.last_time_battery_level_min ) > TIME_CNT_BAT_LEVEL_MIN_INTERVAL )){
		evt_act( EVENT_DENCH_LOW );			// “d’rc—Ê’á‰º
		s_unit.last_time_battery_level_min = now_time;
	}
}

/************************************************************************/
/* ŠÖ”     : main_cpu_com_rcv_sensor_res								*/
/* ŠÖ”–¼   : CPUŠÔ’ÊMóM(ƒZƒ“ƒVƒ“ƒOƒf[ƒ^)							*/
/* ˆø”     : ‚È‚µ														*/
/* –ß‚è’l   : ‚È‚µ														*/
/* •ÏX—š—ğ : 2018.05.19  Axia Soft Design ¼“‡ ‰”Åì¬				*/
/************************************************************************/
/* ‹@”\ : CPUŠÔ’ÊMóM(ƒZƒ“ƒVƒ“ƒOƒf[ƒ^)								*/
/************************************************************************/
/* ’ˆÓ–€ :‚È‚µ														*/
/************************************************************************/
STATIC void main_cpu_com_rcv_sensor_res( void )
...
/************************************************************************/
/* ŠÖ”     : main_cpu_com_rcv_mode_chg									*/
/* ŠÖ”–¼   : CPUŠÔ’ÊMóM(ƒ‚[ƒh•ÏX)									*/
/* ˆø”     : ‚È‚µ														*/
/* –ß‚è’l   : ‚È‚µ														*/
/* •ÏX—š—ğ : 2018.05.19  Axia Soft Design ¼“‡ ‰”Åì¬				*/
/************************************************************************/
/* ‹@”\ : CPUŠÔ’ÊMóM(ƒ‚[ƒh•ÏX)										*/
/************************************************************************/
/* ’ˆÓ–€ :‚È‚µ														*/
/************************************************************************/
STATIC void main_cpu_com_rcv_mode_chg( void )
{
	...
	if( 0 == s_ds.cpu_com.input.rcv_data[0] ){		// ³íI—¹
		s_unit.system_mode = s_unit.next_system_mode;		// ƒ‚[ƒh•ÏX
		
	}else{
		s_unit.system_mode = SYSTEM_MODE_IDLE_COM;				// ƒ‚[ƒh•ÏX
		s_unit.next_system_mode = SYSTEM_MODE_IDLE_COM;			// ƒ‚[ƒh•ÏX
		err_info(ERR_ID_MAIN);
		return;
	}
...
/************************************************************************/
/* ŠÖ”     : main_cpu_com_rcv_disp_order								*/
/* ŠÖ”–¼   : CPUŠÔ’ÊMóM(•\¦w¦)									*/
/* ˆø”     : ‚È‚µ														*/
/* –ß‚è’l   : ‚È‚µ														*/
/* •ÏX—š—ğ : 2018.05.19  Axia Soft Design ¼“‡ ‰”Åì¬				*/
...
/************************************************************************/
/* ŠÖ”     : main_cpu_com_rcv_disp_order								*/
/* ŠÖ”–¼   : CPUŠÔ’ÊMóM(ƒo[ƒWƒ‡ƒ“)									*/
/* ˆø”     : ‚È‚µ														*/
/* –ß‚è’l   : ‚È‚µ														*/
/* •ÏX—š—ğ : 2018.05.19  Axia Soft Design ¼“‡ ‰”Åì¬				*/
/************************************************************************/
/* ‹@”\ : CPUŠÔ’ÊMóM(ƒo[ƒWƒ‡ƒ“)										*/
/************************************************************************/
/* ’ˆÓ–€ :‚È‚µ														*/
/************************************************************************/
STATIC void main_cpu_com_rcv_version( void )
...
STATIC void main_chg_system_mode( SYSTEM_MODE next_mode )
{
	...
	// ¡b’è CPUŠÔ’ÊM‚Ìƒ‚[ƒh•ÏX‚Í‚È‚¢‚Ì‚ÅA’¼Ú‘JˆÚˆ—‚·‚é
	main_mode_chg();
}
...
#if 0
/************************************************************************/
/* ŠÖ”     : main_vuart_rcv_alarm_set									*/
/* ŠÖ”–¼   : VUARTóM(ƒAƒ‰[ƒ€İ’è)									*/
/* ˆø”     : ‚È‚µ														*/
/* –ß‚è’l   : ‚È‚µ														*/
/* •ÏX—š—ğ : 2018.04.16  Axia Soft Design ¼“‡	‰”Åì¬				*/
/************************************************************************/
...
/************************************************************************/
/* ŠÖ”     : main_vuart_snd_alarm_info									*/
/* ŠÖ”–¼   : VUART‘—M(ƒAƒ‰[ƒ€’Ê’m)									*/
/* ˆø”     : ‚È‚µ														*/
/* –ß‚è’l   : ‚È‚µ														*/
/* •ÏX—š—ğ : 2018.04.16  Axia Soft Design ¼“‡	‰”Åì¬				*/
/************************************************************************/
...
//	s_unit.calc.info.dat.state = (newstate | state);
	...
	if(newstate == SNORE_ON){
		...
		{//ƒ‚ƒjƒ^ƒŠƒ“ƒOƒ‚[ƒh‚Å‚È‚¢‚©‚ÂA—}§“®ìÅ‘åŠÔˆÈ‰º
			set_vib(set_vib_mode(vib_str));
		}
	}else{
		s_unit.calc.info.dat.state &= ~(set_ibiki_mask << bit_shift);		// ‚¢‚Ñ‚«ó‘ÔOFF
		s_unit.cnt_time_50ms = 0;	// ‰Šú‰»
	}
	// ‚à‚µA‚¢‚Ñ‚«‚à–³ŒÄ‹z‚à‚Ç‚¿‚ç‚àƒZƒbƒg‚³‚ê‚½‚ç‚¢‚Ñ‚«‚ğ—Dæ‚·‚é‚½‚ßA‚¢‚Ñ‚«ó‘Ô‚Æ‚·‚é
	if( (s_unit.calc.info.dat.state >> bit_shift) & 0x03 == 0x03 ){
		s_unit.calc.info.dat.state &= ~(set_kokyu_mask << bit_shift);		// –³ŒÄ‹zó‘ÔOFF
...
/************************************************************************/
/* ŠÖ”     : main_vuart_rcv_prg_hd_record								*/
/* ŠÖ”–¼   : H1DƒvƒƒOƒ‰ƒ€‘‚«Š·‚¦(ƒŒƒR[ƒh‘‚«‚İ)					*/
/* ˆø”     : ‚È‚µ														*/
/* –ß‚è’l   : ‚È‚µ														*/
/* •ÏX—š—ğ : 2018.04.16  Axia Soft Design ¼“‡	‰”Åì¬				*/
/************************************************************************/
/* ‹@”\ :																*/
/* H1DƒvƒƒOƒ‰ƒ€‘‚«Š·‚¦(ƒŒƒR[ƒh‘‚«‚İ)								*/
/************************************************************************/
/* ’ˆÓ–€ :															*/
/************************************************************************/
STATIC void main_vuart_rcv_prg_hd_record( void )
...
/************************************************************************/
/* ŠÖ”     : main_vuart_rcv_prg_hd_result								*/
/* ŠÖ”–¼   : H1DƒvƒƒOƒ‰ƒ€‘‚«Š·‚¦(“]‘—Œ‹‰Ê)							*/
/* ˆø”     : ‚È‚µ														*/
/* –ß‚è’l   : ‚È‚µ														*/
/* •ÏX—š—ğ : 2018.04.16  Axia Soft Design ¼“‡	‰”Åì¬				*/
/************************************************************************/
...
//	}
	...
	//ƒTƒ€’l”äŠr RD8001b’èFEEPƒ`ƒFƒbƒN‚Ì•û‚ª—Ç‚¢‚©H EEPˆÙí‚Ì“®ì–¢’è‹`
	...
	if( OK == ret ){
		// ¡b’è 7/30 ƒuƒŠƒbƒW‚ÍÁ‚³‚È‚¢‚Æ‚¢‚¯‚È‚¢‚Æv‚í‚ê‚é
...
/************************************************************************/
/* ŠÖ”     : main_vuart_rcv_prg_hd_update								*/
/* ŠÖ”–¼   : H1DƒvƒƒOƒ‰ƒ€‘‚«Š·‚¦(Š®—¹Šm”F)							*/
/* ˆø”     : ‚È‚µ														*/
/* –ß‚è’l   : ‚È‚µ														*/
/* •ÏX—š—ğ : 2018.04.16  Axia Soft Design ¼“‡	‰”Åì¬				*/
/************************************************************************/
/* ‹@”\ :																*/
/* H1DƒvƒƒOƒ‰ƒ€‘‚«Š·‚¦(Š®—¹Šm”F)										*/
/************************************************************************/
/* ’ˆÓ–€ :															*/
/************************************************************************/
STATIC void main_vuart_rcv_prg_hd_update(void)
...
/************************************************************************/
/* ŠÖ”     : main_cpu_com_rcv_prg_hd_ready								*/
/* ŠÖ”–¼   : H1DƒvƒƒOƒ‰ƒ€‘‚«Š·‚¦(“]‘—€”õ)							*/
/* ˆø”     : ‚È‚µ														*/
/* –ß‚è’l   : ‚È‚µ														*/
/* •ÏX—š—ğ : 2018.04.16  Axia Soft Design ¼“‡	‰”Åì¬				*/
...
/************************************************************************/
/* ŠÖ”     : main_cpu_com_rcv_prg_hd_start								*/
/* ŠÖ”–¼   : H1DƒvƒƒOƒ‰ƒ€‘‚«Š·‚¦(“]‘—ŠJn)							*/
/* ˆø”     : ‚È‚µ														*/
/* –ß‚è’l   : ‚È‚µ														*/
/* •ÏX—š—ğ : 2018.04.16  Axia Soft Design ¼“‡	‰”Åì¬				*/
/************************************************************************/
...
/************************************************************************/
/* ŠÖ”     : main_cpu_com_rcv_prg_hd_erase								*/
/* ŠÖ”–¼   : H1DƒvƒƒOƒ‰ƒ€‘‚«Š·‚¦(Á‹)								*/
/* ˆø”     : ‚È‚µ														*/
/* –ß‚è’l   : ‚È‚µ														*/
/* •ÏX—š—ğ : 2018.04.16  Axia Soft Design ¼“‡	‰”Åì¬				*/
...
/************************************************************************/
/* ŠÖ”     : main_cpu_com_rcv_prg_hd_erase								*/
/* ŠÖ”–¼   : H1DƒvƒƒOƒ‰ƒ€‘‚«Š·‚¦(1ƒŒƒR[ƒh•ª‚ğ€”õ)					*/
/* ˆø”     : ‚È‚µ														*/
/* –ß‚è’l   : ‚È‚µ														*/
/* •ÏX—š—ğ : 2018.04.16  Axia Soft Design ¼“‡	‰”Åì¬				*/
/************************************************************************/
/* ‹@”\ :																*/
/* H1DƒvƒƒOƒ‰ƒ€‘‚«Š·‚¦(1ƒŒƒR[ƒh•ª‚ğ€”õ)								*/
/************************************************************************/
/* ’ˆÓ–€ :															*/
/************************************************************************/
STATIC void main_prg_hd_read_eep_record( void )
