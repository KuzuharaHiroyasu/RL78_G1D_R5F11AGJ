...
* Version      : Code Generator for RL78/G1D V1.01.02.03 [24 May 2018]
* Device(s)    : R5F11AGJ
* Tool-Chain   : CCRL
...
#define _02_AD_TEST_AVREFM              (0x02U) /* use - side reference voltage as test signal */
#define _03_AD_TEST_AVREFP              (0x03U) /* use + side reference voltage as test signal */
